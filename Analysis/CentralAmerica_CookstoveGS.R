...
cookstove_files <- list.files(path = "KMLfile/Cookstove_GS/Central America", pattern = "\\.kml$", full.names = TRUE)
...
##########################
overlap_vcs_africa <- perform_overlap_analysis(cookstove_sf_list, avoided_def_list, "Africa", "GS") 
